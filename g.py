...
TOKEN = '7305027848:AAHfUN1SEVx6IJoOlhjWVeV4338Ux0KWK3M'
...
FORWARD_CHANNEL_ID = -1002215060296
CHANNEL_ID = -1002215060296
error_channel_id = -1002215060296
...
def handle_message(message):
    ...
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Dm for Canary @its_Yuvraj_King*", parse_mode='Markdown')
